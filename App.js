...
const DEFAULT_LOCAL_BACKEND_URL = Platform.select({
...
const DEFAULT_BACKEND_URL =
  ...
  (typeof __DEV__ !== 'undefined' && __DEV__ && Platform.OS === 'web'
...
export default function App() {
  ...
  const showInternalTools = Boolean(isDevelopment || frontendConfig?.showInternalPreviewData || adminSession?.token);
  const navItems = [
    ...topNavItems,
      ...
      <ScrollView style={styles.screen} contentContainerStyle={styles.content}>
        <View style={styles.heroCard}>
          ...
          <View style={styles.heroCopy}>
            <Text style={styles.eyebrow}>awroadside-fire Fire</Text>
        ...
        <View style={styles.quickGrid}>
          <Pressable style={styles.quickCard} onPress={() => setSection('guest')}>
            ...
            <Text style={styles.quickBody}>Open the guest request flow and start a new roadside request.</Text>
          </Pressable>
          <Pressable style={styles.quickCard} onPress={() => setSection('subscriber')}>
            <Text style={styles.quickLabel}>Member Access</Text>
            <Text style={styles.quickBody}>Sign in, activate your membership, and manage subscriber requests.</Text>
          </Pressable>
          <Pressable
          ...
          >
            ...
            <Text style={styles.quickBody}>Apply to join the provider network and submit your service profile for review.</Text>
          </Pressable>
          {showInternalTools ? (
            <Pressable style={styles.quickCard} onPress={() => setSection('admin')}>
              <Text style={styles.quickLabel}>Admin Access</Text>
              <Text style={styles.quickBody}>Restricted service controls for account review, approvals, and dispatch support.</Text>
            </Pressable>
          ) : null}
        </View>
      </ScrollView>
  ...
  function renderRequestStatusCard(request) {
    ...
    return (
      <View key={`session-${requestId}`} style={styles.queueCard}>
        ...
        {/* Dispatch tracking placeholder */}
        <View style={styles.mapPlaceholder}>
          <Text style={styles.mapPlaceholderLabel}>Dispatch Tracking Placeholder</Text>
        ...
        {normalizeValue(request.status) === 'EXPIRED' ? (
      ...
      <View style={styles.modalSimFull}>
        <ScrollView style={styles.modalContent}>
          ...
          <Text style={styles.bodyText}>
            By using awroadside-fire Fire, you agree to our Terms of Service and Privacy Policy. 
  ...
  return (
    <SafeAreaView style={styles.app}>
      ...
      <View style={styles.header}>
        <View>
          <Text style={styles.brand}>awroadside-fire Fire</Text>
