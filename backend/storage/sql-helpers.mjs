...
export async function upsertUserRow(sql, user) {
  await sql.query(
...
export async function upsertSubscriberProfileRow(sql, user) {
...
export async function upsertProviderProfileRow(sql, user) {
...
export async function upsertServiceRequestRow(sql, request) {
...
export async function insertPaymentEventRow(sql, entry) {
...
export function buildPerformanceRowsFromUser(user) {
...
export async function upsertPerformanceRow(sql, row) {
  await sql.query(
...
export async function upsertWalletRow(sql, row) {
  await sql.query(
